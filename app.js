/* ============================================================
   ...
   Core app: navigation, grid, tools, pages, blog.
   LOAD ORDER: config → utils → data → [tools] → blog-data → features → app
   ============================================================ */

/* ── Core: showHome, openTool, route (definitions only) ──── */
...
/* ── Grid builders: counts, buildTabs, buildGrid ─────────── */
...
/* ── Boot: listen for hash changes + initial render ─────── */
