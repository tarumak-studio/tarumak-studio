/* TARUMAK STUDIO — marketing-tools.js  (8 marketing tools)
   buildMkCards is a plain function — app.js calls it after load.
   NO IIFE, NO reference to showHome or openTool here. */

function buildMkCards() {
  var g = document.getElementById('mk-home-cards');
  if (!g) return;
